...
def pgp_parse(code_string: str, code_dict: dict) -> tuple:
    ...
    try:
        ...
        logging.exception(error, "A problem was encountered with a paragraph "
                                 "formatting table.")
        pass
...
def ipgpn_parse(code_string: str, current_key: str,
    ...
    try:
        ...
        logging.exception(msg="A paragraph table ipgp "
                              "identifier has caused a problem.")
...
def check_control_words(code_dict: dict, code_string: str,
    ...
    try:
        ...
        logging.exception(error, "A paragraph table code word has created a "
                                 "problem.")
        pass
    return code_string, current_key, code_dict
