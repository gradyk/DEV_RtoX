...
def processor(main_dict: dict) -> dict:
    deck = deque()
    try:
        table_search = main_dict["wif_string"].find("listoverridetable")
        if table_search != -1:
